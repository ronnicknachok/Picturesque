package app.picturesque.data.paging
...
class SearchImageDataSource(private val repo: Repository, private val query: String) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, PhotoItem> {
        return try {
            ...
            val response = repo.searchPhotos(query = query, page = page, perPage = 100)
